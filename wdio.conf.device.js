...
/* TEMPLATE this file's PORT should be provided during templating! */
const APPIUM_PORT = 4723; // 4723;

// let deviceOpts_motox4 = {
...
let device_path = path.resolve(__dirname, 'test/tmp/devices/motox4.json');
let deviceOpts_motox4 = require(device_path);
// let deviceOpts_motox4 = require('./test/tmp/devices/motox4.json');
